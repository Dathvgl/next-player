...
const PageHandle = dynamic(() => import("./components/page-handle"), {
  ssr: false,
});
...
export default function Page() {
  return (
    <div className="game">
      <PageHandle />
      <canvas className="canvas" width={1280} height={850} />
      ...
      <div id="basePlace">
        ...
        {/* List button */}
        <div id="buttons">
          <button className="btnFunction">Start</button>
          <button className="btnFunction">Restart</button>
          <button className="btnFunction">Save</button>
          <button className="btnFunction">Load</button>
          <div id="skills">
      ...
      {/* Feat turret */}
      <div id="turret-upgrade">
        <div className="svg-upgrade">
          <svg
            fill="currentColor"
            viewBox="0 0 24 24"
            strokeWidth="{1.5}"

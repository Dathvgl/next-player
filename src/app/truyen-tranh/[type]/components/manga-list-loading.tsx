          ...
          .map((_, index) => (
            ...
            >
              <figure className="w-full rounded-lg border-2 overflow-hidden">
                <Skeleton className="w-full h-[200px] bg-stone-300" />
                <figcaption className="py-1 flex flex-col gap-1">
                  <Skeleton className="w-full h-[24px] bg-stone-300" />
                  <ul className="flex flex-col gap-1">
                    {Array(3)
                      ...
                      .map((_, index) => (
                        <li
                          key={index}
                          className="flex justify-between gap-2 h-4"
                        >
                          <Skeleton className="flex-1 h-full bg-stone-300" />
                          <Skeleton className="w-2/3 h-full bg-stone-300" />
                        </li>
                      ))}
                  </ul>
                </figcaption>
